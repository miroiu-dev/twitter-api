export const UploadImage: React.FC<{ className?: string }> = ({
	className,
}) => {
	return (
...
export const UploadGIF: React.FC<{ className?: string }> = ({ className }) => {
	return (
		<svg viewBox="0 0 24 24" className={className}>
			<g>
...
export const Poll: React.FC<{ className?: string }> = ({ className }) => {
	return (
		<svg viewBox="0 0 24 24" className={className}>
			<g>
...
export const Emoji: React.FC<{ className?: string }> = ({ className }) => {
	return (
		<svg viewBox="0 0 24 24" className={className}>
			<g>
